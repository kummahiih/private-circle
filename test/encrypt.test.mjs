...
describe('encryptPage (integration)', () => {
  ...
  const GATE_CSP =
    "default-src 'none'; base-uri 'none'; form-action 'none'; script-src 'self'; style-src 'self'; connect-src 'self'; img-src 'none'; font-src 'none'; object-src 'none'; frame-ancestors 'none'";
  const ENROLL_CSP =
